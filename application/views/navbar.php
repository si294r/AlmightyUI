                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="<?php echo base_url('referrer') ?>" class="dropdown-toggle <?php echo in_array($class,['referrer']) ? 'menu-active' : '' ?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    Referrer </span>
                                </a>
                            </li>    
                        </ul>
